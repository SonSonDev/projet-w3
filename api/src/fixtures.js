  ...
  "ENERGY": [
    {
      ...
      content: `Que faire avec les cendres de son poêle à bois ? De la lessive maison bien sûr ! La cendre de bois est naturellement riche en potasse, ce qui lui donne des propriétés lavantes. Cette recette de lessive à la cendre est simple, économique et zéro déchet !\n\n
## Ingrédients :\n\n
...
Si on utilise un flacon airless, c’est très bien car on touche seulement le produit qu’on applique directement. Si on a mis la crème dans un pot classique, on la prélève plutôt avec une petite spatule ou une cuillère pour éviter de déposer des germes dans le reste du produit.\n\n
    ...
    },
    {
      ...
      content: `## Pourquoi devenir éco-responsable ?\n\n
...
Attention, hautement addictif ! Dans tous les cas, cela reste un produit gras et sucré à consommer avec modération ;-)\n\n
    ...
    },
    {
      ...
      content: `Respecter l'environnement, ce n'est pas seulement consommer moins... c'est aussi acheter de manière éco-responsable. Voici 12 conseils qui vous aideront à faire le bon choix en magasin et à la maison.\n\n
...
const defaultArticles = [
  {
    ...
    "content": `Dégivrer son congélateur n'a rien de bien compliqué. Et cela vous permettra à la fois de stocker vos aliments dans un environnement sain, mais aussi de contribuer au bon état de votre appareil.\n\n
